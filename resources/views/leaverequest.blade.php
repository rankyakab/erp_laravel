		       ...
		       <div class="col-12 col-lg-12">
				...
				<div class="card-header">
				  ...
				  <div class="card-body" style="padding-top: 30px;">
				  	<div class="form-body">
					 <form class="row g-3" action="submitleaveapplication" id="submitleaveapplication" method="post" enctype="multipart/form-data">
					 	@csrf
					 	<div class="col-sm-12">
					 		<label for="inputFirstName" class="form-label">Title <span class="required" >*</span></label>
							<input type="text" class="form-control" id="title" name="title" placeholder="Leave Title" maxlength="225" required>
					 	</div><br />
					 	<div class="col-sm-12">
					 	<div class="row g-3">
						 	<div class="col-sm-3">
					...
					<div class="col-sm-12">
					 	...
					 	<div class="col-sm-12">
							...
							<textarea class="form-control" id="leavebody" name="leavebody" placeholder="Body of Leave Application" maxlength="1000" style="height: 300px;" required></textarea>
