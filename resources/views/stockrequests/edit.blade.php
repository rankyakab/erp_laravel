									...
									<div class="card-header">
										<div class="d-flex align-items-center">
											<div>
												...
												@endphp		
												<h5 class="mb-0">Edit {{$stock_name}} Stock Request</h5>
											</div>
											...
											<center>
												...
												<!--image upload starts here--->
															<div class="fileinput fileinput-new text-center" data-provides="fileinput">
																...
																<img src="@if(is_null($stock_image)){{asset("assets/images/signature.jpg")}} @else {{asset($stock_image)}} @endif" width="250px" alt="..." id="stock_image">
																</div>
