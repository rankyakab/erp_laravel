					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0" style="background-color: transparent;">
								...
								<li class="breadcrumb-item active" aria-current="page">Request for Stock</li>
							</ol>
						</nav>
					</div>
				</div>
						...
						<div class="card radius-10">
									<div class="card-header">
										<div class="d-flex align-items-center">
											<div>
												<h5 class="mb-0">Stock Request</h5>
											</div>
									...
									<div class="card-body" style="padding-top: 40px;">
										<x-flash-message />
										<div class="form-body">
										<form class="row g-3" action="/stockrequestcreate" id="submitstock" method="post" enctype="multipart/form-data">
											@csrf
											<div class="col-sm-4">
											<center>
											...
											<div class="row my-5">
												...
												<div class="col-sm-6">
													...
													<input type="number" class="form-control" required id="qty_requested"  name="qty_requested"  value="{{old('qty_requested')}}" placeholder="Quantity Requested">
													@error('qty_requested')
														<p class="text-red-500 text-danger text-xs mt-1">{{$message}}</p>
														@enderror
