		       ...
		       <div class="col-12 col-lg-12">
				...
				<div class="card-header">
					<div class="d-flex align-items-center">
						<div>
							<h4 class="mb-0">Add Branch Office</h4>
						</div>
					</div>
				</div>
				  <div class="card-body">
					 ...
					 <form class="row g-2" method="POST" action="submitoffices" id="submitoffices">
					 	...
					 	<div class="col-sm-8">
					 		...
					 		<input type="text" name="offices" id="offices" class="form-control" placeholder="Enter Office" required>
								...
								<tbody>
									...
									<tr>
										...
										@if(app\Http\Controllers\Controller::checkrole(Auth::user()->role, 8, 7) == "allow")	
											<a href="{{ $office->id }}" class="editoffice" id="{{ $office->offices }}"><svg title="Click to edit row" class="vouchericon" id="editrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="m19.3 8.925l-4.25-4.2l1.4-1.4q.575-.575 1.413-.575t1.412.575l1.4 1.4q.575.575.6 1.388t-.55 1.387L19.3 8.925ZM17.85 10.4L7.25 21H3v-4.25l10.6-10.6l4.25 4.25Z"/></svg></a>
                                        @endif
                                        @if(app\Http\Controllers\Controller::checkrole(Auth::user()->role, 8, 8) == "allow")
											<a href="{{ $office->id }}" class="deleteoffice" id="{{ $office->id }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M7 21q-.825 0-1.413-.588T5 19V6H4V4h5V3h6v1h5v2h-1v13q0 .825-.588 1.413T17 21H7ZM17 6H7v13h10V6ZM9 17h2V8H9v9Zm4 0h2V8h-2v9ZM7 6v13V6Z"/></svg></a>
                                        @endif
										</td>
