...
<body>
    ...
    <div style="width: 100%; margin: margin-top: -20px;">
    ...
    <div style="width: 100%; margin-top: -20px; padding-left: 20px;">
        ...
        <div style="width: 40%; float: right;">
            <h5>Receipt Date #: {{ date('d F Y') }}
            <br />Ref #: {{ $invoices[0]->refno }}
            <br />Receipt #: {{ $invoices[0]->invoiceno }}
            <br />{{ $office[0]->tin }}</h5>
        </div>
    </div>
    <table style="position: relative; top: 100px;">
        ...
        <thead>
            <tr>    
                ...
                <th><b>Description</th>
                <th><b>QTY</th>
                <th><b>Price ({{ $invoices[0]->currency }})</th>
                <th><b>Amount ({{ $invoices[0]->currency }})</th>
        </thead>
        <tbody id="sheetdata">
            @php $x=1 @endphp
    ...
    <div style="width: 100%; margin-top: 200px; padding-left: 20px;">
        ...
        <div style="width: 40%; float: right;">
            <h6>Receipt Generated on {{ date('d/m/Y') }}</h6>
        </div>
    </div>
