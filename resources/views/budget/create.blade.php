					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0" style="background-color: transparent;">
								...
								<li class="breadcrumb-item active" aria-current="page">Add New Office Budget</li>
							</ol>
						</nav>
					</div>
				</div>
		        ...
		        <div class="card radius-10">
					<div class="card-header">
						<div class="d-flex align-items-center">
							<div>
								<h5 class="mb-0">Create Office Budget Request</h5>
								<p>Kindly fill in the form below to submit a Office Budget request</p>
							</div>
				  ...
				  <div class="card-body" style="padding-top: 40px;">
				     	<div class="form-body">
							<form class="row g-3" action="/budgetcreate" id="budgetcreate" method="post"  enctype="multipart/form-data">
								@csrf
								...
								<div class="row">
									<div class="col-sm-4">
										...
										<input type="text" class="form-control" id="number" name="number" placeholder="Number of Budget"  value="{{old('number')}}"  required>
										@error('number')
