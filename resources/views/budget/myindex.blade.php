					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item " aria-current="page">My Budget Records</li>
							</ol>
						</nav>
					</div>
			...
			<div class="card-body">
                <div class="row">
						 	<div class="col-sm-6">
			                	...
			                	<h6 class="mb-0 text-uppercase">My Budget Table</h6>
							</div>
						 	<div class="col-sm-6">
								...
								<tbody>
                                    @unless (count($budgets)==0)
										  ...
										  @php
											 ...
											 if($budget->requested_by != Auth::user()->profileid){
                                            continue;
                                          }
                                            ...
                                            <tr>
                                                <td><a href="/budget{{$budget->id}}">{{ $key+1}}  </a></td>
                                                <td> {{ $budget->number }} </td>
